...
## Step-by-Step
Not applicable — this is a concept/orientation page. See `/docs/how-it-works` for the detailed component walkthrough.
...
## Related Docs
- `/docs/how-it-works` — detailed component communication flow
- `/docs/how-dns-works-with-twingate` — DNS interception deep dive
- `/docs/p2p-communication` — peer-to-peer connection mechanics
- `/docs/nat-traversal` — relay fallback behavior
